...
final class ProfileViewController: UIViewController {
    ...
    private lazy var settingsButtonAction = UIAction { _ in
    ...
    private lazy var vStackFriendsLabels: UIStackView = {
        $0.axis = .vertical
    ...
    private lazy var vStackSubscribesLabels: UIStackView = {
        $0.axis = .vertical
        $0.distribution = .fillEqually
    ...
    private lazy var vStackFavouritesLabels: UIStackView = {
        $0.axis = .vertical
        $0.distribution = .fillEqually
    ...
    private lazy var moreInfoAction = UIAction { _ in
