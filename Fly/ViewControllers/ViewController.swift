...
final class ViewController: UIViewController {
    ...
    private let collectionData = OnboardingModel.mockData()
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        $0.register(
            OnboardingCell.self,
            forCellWithReuseIdentifier: OnboardingCell.reuseId
        )
        $0.dataSource = self
...
extension ViewController: UICollectionViewDataSource {
    ...
    func collectionView(
        ...
        let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: OnboardingCell.reuseId,
            for: indexPath
        ) as! OnboardingCell
        ...
        cell.transitionOnAuthVC = { [weak self] in
